...
The tables below show the number per species sampled
...
datasummary_crosstab(SPECIES_NAME ~ RecFIN_Port_Name, statistic = 1 ~ N, title = 'Number of Species Sampled by CDFW Management Region', data = CRSP_Data)

Northern <- CRSP_Data %>%
  group_by(RecFIN_Port_Name) %>%
  filter(RecFIN_Port_Name == "Northern")
datasummary_crosstab(SPECIES_NAME ~ Vessel, statistic = 1 ~ N, title = 'Number of Species Sampled by Vessels in the Northern Management Region', data = Northern)

Mendocino <- CRSP_Data %>%
  group_by(RecFIN_Port_Name) %>%
  filter(RecFIN_Port_Name == "Mendocino")
datasummary_crosstab(SPECIES_NAME ~ Vessel, statistic = 1 ~ N, title = 'Number of Species Sampled by Vessels in the Mendocino Management Region', data = Mendocino)

San_Francisco <- CRSP_Data %>%
  group_by(RecFIN_Port_Name) %>%
  filter(RecFIN_Port_Name == "San Francisco")
datasummary_crosstab(SPECIES_NAME ~ Vessel, statistic = 1 ~ N, title = 'Number of Species Sampled by Vessels in the San Francisco Management Region', data = San_Francisco)

Central <- CRSP_Data %>%
  group_by(RecFIN_Port_Name) %>%
  filter(RecFIN_Port_Name == "Central")
datasummary_crosstab(SPECIES_NAME ~ Vessel, statistic = 1 ~ N, title = 'Number of Species Sampled by Vessels in the Central Management Region', data = Central)

Southern <- CRSP_Data %>%
  group_by(RecFIN_Port_Name) %>%
  filter(RecFIN_Port_Name == "Southern")
datasummary_crosstab(SPECIES_NAME ~ Vessel, statistic = 1 ~ N, title = 'Number of Species Sampled by Vessels in the Southern Management Region', data = Southern)
